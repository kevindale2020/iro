...
public class SessionManager {
    ...
    public void createSession(String id, String image, String fname, String lname, String nname, String occupation, String address, String email, String contact, String username) {
        editor.putBoolean(LOGIN, true);
        editor.putString(USER_ID, id);
        editor.putString(USER_IMAGE, image);
        editor.putString(FIRST_NAME, fname);
        editor.putString(LAST_NAME, lname);
        editor.putString(NICKNAME, nname);
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        user.put(OCCUPATION, sharedPreferences.getString(OCCUPATION,null));
