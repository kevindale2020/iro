...
public class ItemActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ItemAdapter(itemsList, ItemActivity.this);
    ...
    public void loadItems() {
        String url = "http://192.168.137.1:8080/IRO/Android/items.php";
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                for (int i = 0; i < resultArray.length(); i++) {
                                    ...
                                    Items items = new Items(object.getInt("item_id"), imageURL, object.getString("item_name"), object.getString("item_category_desc"), object.getInt("item_qty"), object.getDouble("item_price"));
                                    itemsList.add(items);
                                }
                                adapter = new ItemAdapter(itemsList, ItemActivity.this);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch(menuItem.getItemId()) {
            ...
            case R.id.nav_password:
                Intent a = new Intent(ItemActivity.this, ChangePasswordActivity.class);
                startActivity(a);
                break;

            case R.id.nav_adoption:
                Intent b = new Intent(ItemActivity.this, MyAdoptionActivity.class );
                startActivity(b);
                break;

            case R.id.nav_report1:
                Intent c = new Intent(ItemActivity.this, Report1Activity.class);
                startActivity(c);
                break;

            case R.id.nav_volunteer:
                Intent d = new Intent(ItemActivity.this, VolunteerActivity.class);
                startActivity(d);
                break;

            case R.id.nav_guidelines:
                Intent e = new Intent(ItemActivity.this, GuidelinesActivity.class);
                startActivity(e);
                break;

            case R.id.nav_my_reports:
                Intent f = new Intent(ItemActivity.this, MyReportActivity.class);
                startActivity(f);
                break;

            case R.id.nav_donation:
                Intent g = new Intent(ItemActivity.this, DonationActivity.class);
                startActivity(g);
                break;
        }
        return  true;
