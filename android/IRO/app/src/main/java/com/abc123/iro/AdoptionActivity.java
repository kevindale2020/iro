...
public class AdoptionActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new PetAdapter(petsList, AdoptionActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.notification:
                Intent intent = new Intent(AdoptionActivity.this, NotificationActivity.class);
                startActivity(intent);
    ...
    */
    ...
    public void loadAdoptions() {
        String url = "http://192.168.137.1:8080/IRO/Android/adoptions.php";
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch(menuItem.getItemId()) {
            case R.id.nav_logout:
                AlertDialog.Builder builder = new AlertDialog.Builder(AdoptionActivity.this);
            ...
            case R.id.nav_password:
                Intent a = new Intent(AdoptionActivity.this, ChangePasswordActivity.class);
                startActivity(a);
                break;

            case R.id.nav_adoption:
                Intent b = new Intent(AdoptionActivity.this, MyAdoptionActivity.class );
                startActivity(b);
                break;

            case R.id.nav_report1:
                Intent c = new Intent(AdoptionActivity.this, Report1Activity.class);
                startActivity(c);
                break;

            case R.id.nav_volunteer:
                Intent d = new Intent(AdoptionActivity.this, VolunteerActivity.class);
                startActivity(d);
                break;

            case R.id.nav_guidelines:
                Intent e = new Intent(AdoptionActivity.this, GuidelinesActivity.class);
                startActivity(e);
                break;

            case R.id.nav_my_reports:
                Intent f = new Intent(AdoptionActivity.this, MyReportActivity.class);
                startActivity(f);
                break;

            case R.id.nav_donation:
                Intent g = new Intent(AdoptionActivity.this, DonationActivity.class);
                startActivity(g);
                break;
        }
        return  true;
