...
if($_SERVER['REQUEST_METHOD']=='POST') {
	...
	while($row = mysqli_fetch_array($sql3)) {
		$adminid = $row['user_id'];
		$sql3 = mysqli_query($connection, "INSERT INTO `notifications` (`notification_id`, `user_id`, `notification_type_id`, `subject`, `content`, `date`, `is_seen`, `is_seen_admin`) VALUES (NULL, '$adminid', '1', 'Adoption', 'Pet Adoption Application Form has been cancelled', '$date', '1', '0')");
	}
	*/
