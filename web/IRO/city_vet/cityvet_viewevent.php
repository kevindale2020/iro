                                ...
                                <table class="table table-borderless">
                                  <tr>
                                    ...
                                    <td style="float: left;"><?php echo "$row[title]"; ?><span style="padding-right: 30px"></span>
                                      ...
                                      {
                                        echo "<a href='cityvet_editevent.php?id=$row[id]' title='Edit' class='btn-outline-success btn-sm openPopup'><i class='fa fa-edit'></i>

                                        </a> | <a href='cityvet_deleteevent.php?id=$row[id]' onclick=\"return confirm('Are you sure you want to remove this event?')\" class='btn-outline-danger btn-sm'><i class='fa fa-trash'></i></a>";
                                      }
                                      else
                                      {
