    ...
    if (empty($image) || $image == "") 
    {
      ...
      else
      {
        ...
        if (mysqli_query($database, $sql)) 
        {
          ...
          {
              $message = 'New city vet staff has been added successfully';
          }
        }
      }
          ...
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-7 ">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                <form class="user" method="post" action="cityvet_adduser.php" enctype="multipart/form-data">
                  <div class="form-group">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <div id="input-4">
                      ...
                      <input type="text" class="form-control form-control-user" name="contact" id="cnumber" placeholder="09######### / +639########" value="<?= isset($_POST['cnumber']) ? $_POST['cnumber'] : ''; ?>" required>
                    </div>
                  </div>
                </div>
                <div class="form-group row">
