...
if (isset($_POST['save']))
{
  ...
  if (empty($image) || $image == '') 
  {
    ...
    {
          echo "<script>window.location.href='cityvet_viewevent.php?success=$success';</script>";
    }
  }
  else
  {
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <form method="post" action="cityvet_editevent.php" enctype="multipart/form-data">
                              ...
                              <div class="col-lg-8">
                                <table class="table table-borderless">
                                  <tr>
                                    ...
                                    <td style="float: left;"><input type="" class="form-control" name="title" value="<?php echo $row['title']; ?>"></td>
                                    <input type="hidden" name="id" value="<?php echo $id ?>">
                                  </tr>
                                   <tr>
                                    <td width="100px">Description: </td>
                                    <td><textarea class="form-control" rows="5" name="description"><?php echo $row['desc'] ?></textarea></td>
                                  </tr>
                                  <tr>
                                    <td style="padding-right: 10px">Venue: </td>
                                    <td style="float: left;"><input type="text" name="venue" class="form-control" value="<?php echo $row['venue'] ?>" ></td>
                                  </tr>
                                  ...
                                  <!-- Datepicker -->
                                   ...
                                   <tr>
                                    ...
                                    <!-- end -->
                                    <input id="datepicker" class="form-control" type="text" name="start" readonly='true' value="<?php echo $new_start ?>" />
                                    <script>
                                   ...
                                   <tr>
                                    ...
                                    <link href="https://unpkg.com/gijgo@1.9.13/css/gijgo.min.css" rel="stylesheet" type="text/css" />
                                    <!-- end -->
                                    <input id="datepicker2" class="form-control" type="text" name="end" readonly='true' value="<?php echo $new_end ?>"/>
                                    <script>
                                   ...
                                   <tr>
                                    ...
                                    <td style="float: left;"><input type="time" name="time_start" value=<?php echo $timestart ?> class="form-control"></td>
                                  </tr>

                                   <tr>
                                    <td style="padding-right: 10px">Time End: </td>
                                    <td style="float: left;"><input type="time" name="time_end" value=<?php echo $timeend ?> class="form-control"></td>
                                  </tr>
                                </table>
                                <hr>
                              </div>          
