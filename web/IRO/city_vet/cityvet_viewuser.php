              ...
              echo "<td>".$row['role_desc']."</td>";
                ...
                if ($row['is_active'] == 0) 
                {
                    ...
                    else
                    {
                      ...
                      {
                        echo "<td><a class='btn btn-success' href=\"cityvet_manageaccount.php?activate=$row[user_role_id]\" onclick=\"return confirm('Are you sure you want to activate this account?')\" title='Activate Account'><i class='fa fa-check fa-fw'></i></a></td>";
                      }
                    }
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    {
                      echo "<td><a class='btn btn-danger' href=\"cityvet_manageaccount.php?deactivate=$row[user_role_id]\" onclick=\"return confirm('Are you sure you want to deactivate this account?')\" title='Deactivate Account'><i class='fa fa-ban fa-fw'></i></a></td>";
                    }
                  }
                }
