...
if (isset($_POST['SaveImage'])) 
{
  ...
  {
    $error_image = 'Only jpg, jpeg and png files are allowed.';
  }
  else
  {
          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <!-- Card Body -->
                <div class="card-body">
                  <form method="post" action="admin_editprofile.php" enctype="multipart/form-data">
                  <center>
            ...
            <div class="col-xl-8 col-lg-7 ">
              <div class="card shadow mb-4">
                ...
                <!-- Card Body -->
                <div class="card-body">
                <form class="user" method="post" action="admin_editprofile.php">
                <div class="form-group">
                <script>
                setTimeout(function(){
                  document.getElementById('info-message').style.display = 'none';
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <div id="input-1">
                      ...
                      <input type="text" class="form-control form-control-user" name="fname" id="firstname" value="<?php echo $user_fname ?>" required>
                    </div>
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <div id="input-2">
                      ...
                      <input type="text" class="form-control form-control-user" id="lastname" name="lname" value="<?php echo $user_lname ?>" required>
                    </div>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <div id="input-3">
                      ...
                      <input type="text" class="form-control form-control-user" name="nname" id="nname" value="<?php echo $nname ?>" required>
                    </div>
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <div id="input-4">
                      ...
                      <input type="text" class="form-control form-control-user" name="contact" id="cnumber" value="<?php echo $contact ?>" required>
                    </div>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <div id="input-5">
                      ...
                      <input type="text" class="form-control form-control-user" name="occupation" id="occupation" value="<?php echo $occupation ?>" required>
                    </div>
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <div id="input-6">
                      ...
                      <input type="text" class="form-control form-control-user" name="address" id="address" value="<?php echo $address ?>" required>
                    </div>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <div id="input-7">
                      ...
                      <input type="email" class="form-control form-control-user" name="email" id="email" value="<?php echo $email ?>" required>
                    </div>
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <div id="input-8">
                      ...
                      <input type="text" class="form-control form-control-user" name="username" id="username" value="<?php echo $username ?>" required>
                    </div>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="submit" name="save" value="Save" id="edit" class="btn btn-success btn-user btn-block">
                  </div>
                </div>
              </form>
                </div>
