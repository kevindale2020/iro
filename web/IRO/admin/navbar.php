          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!-- Counter - Alerts -->
                <span class="badge badge-danger badge-counter"><div id="count"></div></span>
              </a>
              <!-- Dropdown - Alerts -->
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <div id="notif" style="overflow-y: auto; max-height: 500px"></div>

                <?php echo "<a class='dropdown-item text-center small text-gray-500' href=\"remove_seen.php?remove_all\">Clear Seen Notifications</a>"; ?>
                <?php echo "<a class='dropdown-item text-center small text-gray-500' href=\"showall_notif.php\">Show All Notifications</a>"; ?>
              </div>
            </li>
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="admin_editprofile.php">
