  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
        <center><h1 class="h3 mb-0 text-gray-800">HOMELESS PET</h1></center>
        ...
        <div class="card-body">
            ...
            <div class="row" style="width: 105%">
                <?php 
                if (mysqli_num_rows($homeless_pet) == 0) 
                {
                  ?>
                ...
                {
                  while ($row = mysqli_fetch_array($homeless_pet)) 
                  {
                      $title = $row['title'];
