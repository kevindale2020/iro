...
if (isset($_POST['submit']))
{
  ...
  $getUsers = mysqli_query($database, "SELECT * FROM users INNER JOIN user_roles ON users.user_id = user_roles.user_id INNER JOIN roles ON user_roles.role_id = roles.role_id WHERE roles.role_id = 1 OR roles.role_id = 3");
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <a href="admin_viewuser.php" class="custom-card">
              <div class="card border-left-primary shadow h-100 py-2" style="width: 15rem; display: inline-block">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Users</div>
                      <div class="h3 mb-0 font-weight-bold text-gray-800"><div id="users"></div></div>
                    </div>
                    <div class="col-auto">
            ...
            <!-- Available Pet -->
            <div class="col-xl-3 col-md-6 mb-4">
              <a href="admin_viewpet.php?available=1" class="custom-card">
              <div class="card border-left-success shadow h-100 py-2" style="width: 15rem; display: inline-block">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Available Pet</div>
                      <div class="h3 mb-0 font-weight-bold text-gray-800"><div id="availablepet"></div></div>
                    </div>
                    <div class="col-auto">
            ...
            <!-- Adopted Pet -->
            <div class="col-xl-3 col-md-6 mb-4">
              <a href="admin_viewpet.php?adopted=2" class="custom-card">
              <div class="card border-left-info shadow h-100 py-2" style="width: 15rem; display: inline-block">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Adopted Pet</div>
                      <div class="h3 mb-0 font-weight-bold text-gray-800"><div id="adoptedpet"></div></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-paw fa-2x text-gray-300"></i>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <a href="admin_donation.php" class="custom-card">
              <div class="card border-left-warning shadow h-100 py-2" style="width: 15rem; display: inline-block">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1" href="admin_donation.php" >Total Donation</div>
                      <div class="h3 mb-0 font-weight-bold text-gray-800"><div id="totaldonation"></div></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <a href="admin_adoptionrequest.php" class="custom-card">
              <div class="card border-left-primary shadow h-100 py-2" style="width: 15rem; display: inline-block">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1" href="admin_adoptionrequest.php" >Adoption Requests</div>
                      <div class="h3 mb-0 font-weight-bold text-gray-800"><div id="adoptionrequest"></div></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <a href="#" class="custom-card" data-toggle="modal" data-target="#rescueModal">
              <div class="card border-left-success shadow h-100 py-2" style="width: 15rem; display: inline-block">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1" href="admin_animalcruelty.php" >Rescue Requests</div>
                      <div class="h3 mb-0 font-weight-bold text-gray-800"><div id="rescue">0</div></div>
                    </div>
                    <div class="col-auto">
                      <i class="fa fa-paper-plane fa-2x text-gray-300"></i>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <a href="admin_lostandfound.php" class="custom-card">
              <div class="card border-left-info shadow h-100 py-2" style="width: 15rem; display: inline-block">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1" href="admin_lostandfound.php" >Report Requests</div>
                      <div class="h3 mb-0 font-weight-bold text-gray-800"><div id="lostandfound"></div></div>
                    </div>
                    <div class="col-auto">
                      <i class="fa fa-paper-plane fa-2x text-gray-300"></i>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <a href="admin_volunteerrequest.php" class="custom-card">
              <div class="card border-left-warning shadow h-100 py-2" style="width: 15rem; display: inline-block">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1" href="admin_volunteerrequest.php" >Volunteer Requests</div>
                      <div class="h3 mb-0 font-weight-bold text-gray-800"><div id="volunterrequest"></div></div>
                    </div>
                    <div class="col-auto">
                      <i class="fa fa-paper-plane fa-2x text-gray-300"></i>
                    </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_array($aw))
                    {
                      ...
                      echo "<td><a class='btn btn-outline-primary btn-sm' href='admin_index.php?id=$id'><i class='fa fa-sm fa-eye'></i></a></td>";
                      echo "</tr>";
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                      <div class="dropdown-header">Event Option:</div>
                      <a class="dropdown-item" href="#" data-toggle="modal" data-target="#exampleModal">Add Event</a>
                      <a class="dropdown-item" href="admin_viewevent.php">View Events</a>
                    </div>
                  </div>
                </div>
                <!-- Card Body -->
