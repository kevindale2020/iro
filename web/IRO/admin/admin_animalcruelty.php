...
<head>
  ...
  <title>IRO - Animal Cruelty</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
        <center><h1 class="h3 mb-0 text-gray-800">ANIMAL CRUELTY</h1></center>
        ...
        <div class="card-body">
            ...
            <div class="row" style="width: 105%">
                <?php 
                if (mysqli_num_rows($animal_cruelty) == 0) 
                {
                  ?>
                ...
                {
                  while ($row = mysqli_fetch_array($animal_cruelty)) 
                {
                    $title = $row['title'];
                            ...
                            <div class="float-left">
                                <table>
                                    <tr>
                                        ...
                                        <td><p class="card-text" style="overflow:hidden;text-overflow:ellipsis; text-align: justify;"><?php echo $description; ?>.</p></td>
                                    </tr>
                                    <tr>
                                      <td></td>
                                    </tr>
                    ...
                    <div class="card">
                           <div class='container'>
                            <img class='img' src="../Android/images/attachments/<?php echo $file_name ?>" style='width: 500px; height: 300px'>
                            <div class="top-right">
                              <a href="admin_managereport.php?closed=<?php echo $doc_id ?>" onclick="return confirm('Are you sure you want to close this case?')" title="Closed"><i class="fa fa fa-ban fa-3x" style="color: red; background-color: white; "></i></a>
                            </div>
                            <div class="centered">
                              <p style="color: white; font-style: italic; font-size: 36px; background-color: skyblue; opacity: 0.7">ACKNOWLEDGE</p>
                            </div>
                           </div>; 
                        <div class="card-body bg-light">
                            <center>
