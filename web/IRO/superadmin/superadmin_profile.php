          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <!-- Card Body -->
                <div class="card-body">
                  <form method="post" action="superadmin_profile.php" enctype="multipart/form-data">
                  <center>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="text" class="form-control form-control-user" name="fname" disabled value="<?php echo $user_fname ?>">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <h1 class="h5 mb-0 text-gray-800">Last Name</h1>
                    <input type="text" class="form-control form-control-user" name="lname" disabled value="<?php echo $user_lname ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <h1 class="h5 mb-0 text-gray-800">Nickname</h1>
                    <input type="text" class="form-control form-control-user" name="nname" disabled value="<?php echo $nname ?>">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <h1 class="h5 mb-0 text-gray-800">Contact Number</h1>
                    <input type="text" class="form-control form-control-user" name="contact" disabled value="<?php echo $contact ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <h1 class="h5 mb-0 text-gray-800">Occupation</h1>
                    <input type="text" class="form-control form-control-user" name="occupation" disabled value="<?php echo $occupation ?>">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <h1 class="h5 mb-0 text-gray-800">Address</h1>
                    <input type="text" class="form-control form-control-user" name="address" disabled value="<?php echo $address ?>">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <h1 class="h5 mb-0 text-gray-800">Email</h1>
                    <input type="text" class="form-control form-control-user" name="email" disabled value="<?php echo $email ?>">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <h1 class="h5 mb-0 text-gray-800">Username</h1>
                    <input type="text" class="form-control form-control-user" name="username" disabled value="<?php echo $username ?>">
                  </div>
                </div>
              </div>
            </div>
